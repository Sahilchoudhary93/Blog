                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="form-group">
                                            <input type="text" name="Title" value={obj.Title?obj.Title:""} onChange={set} placeholder="Enter your Title" required />
                                        </div>
                                    </div>
                                    <div className="col-lg-6">
                                        <div className="form-group">
                                            <input type="text" name="Author" value={obj.Author?obj.Author:""} onChange={set} placeholder="Enter the Author Name" required />
                                        </div>
                                    </div>
                                    <div className="col-lg-12">
                                        <div className="form-group">
                                            <input type="text" name="Heading" value={obj.Heading?obj.Heading:""} onChange={set} placeholder="Enter the Heading" required />
                                        </div>
                                    </div>
                                    <div className="col-lg-12">
                                        <div className="form-group">
                                            <textarea name="Description" value={obj.Description?obj.Description:""} onChange={set} placeholder='Enter the Description' id=""></textarea>
                                        </div>
                                    </div>
                                    <div className="col-lg-6">
                                        <div className="form-group">
                                            <input type="text" name="Category" value={obj.Category?obj.Category:""} onChange={set} placeholder="Enter your Category" />
                                        </div>
                                    </div>
                                    <div className="col-lg-6">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="form-group">
                                        <a className="btn-two w-100 d-block" style={{height:"48px",padding:"9px"}} onClick={Create}>Create Sub-Heading<i className="flaticon-right-arrow" /></a>
                                        </div>
                                    </div>
                                    {
